  ...
  return (
    <main className="p-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
        ...
        <Kpi label="Esperando activación" value={stats.pendientes} highlight={stats.pendientes > 0} />
            ...
            <div>
              ...
              <p className="text-muted text-xs">
                Estado: <span className={
                  b.plan_status === "active" ? "text-ok" : b.plan_status === "demo" ? "text-warn" : b.plan_status === "pending" ? "text-accentSoft" : "text-danger"
                }>{b.plan_status}</span>
